...
Сейчас в репозитории размещён один реальный скриншот интерфейса. Актуальный скриншот ESP можно будет добавить после появления настоящего снимка V18.4.
...
- `screenshots/trainer-main.jpg` — реальный скриншот интерфейса
